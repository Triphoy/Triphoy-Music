        ...
        <div className="events-section">
          ...
          <div className="events-container">
            {events.map((event, index) => (
              <div 
                className={`event-card ${index === currentEventIndex ? 'active' : ''}`} 
                key={event.id}
              ...
              >
                <div className="event-content">
                  <div className="event-header">
                    ...
                    <span className="event-badge">18+</span>
                  </div>
              ...
              {[1, 2, 3, 4, 5, 6].map(i => (
                <div className="artist-card" key={i}>
                  ...
                  <div className="artist-info">
                    <div className="artist-name">{["Triphoy", "OsamaSon", "Ken Carson", "Che", "Destroy Lonely", "Yeat"][i-1]}</div>
                    <div className="artist-songs">{[12, 8, 15, 10, 7, 20][i-1]} треков</div>
